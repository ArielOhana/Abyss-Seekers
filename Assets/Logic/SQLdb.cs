...
=======
        ...
        {
            //insertCommand.CommandText = $"INSERT INTO {tableName} ({string.Join(", ", data.Keys)}) VALUES ({string.Join(", ", data.Keys.Select(key => "@" + key))})";
...
=======
        ...
        private void UpdateHeroRow(SqliteCommand command, Hero hero)
        {
            //command.Parameters.Clear();
            //command.CommandText = "UPDATE hero SET XP = @XP, Level = @Level  WHERE Id = @Id";
            //command.Parameters.AddWithValue("@XP", hero.XP);
        ...
        private void UpdateInventoryRow(SqliteCommand command, Inventory inventory)
        {
            //command.Parameters.Clear();
        ...
        public void entityToUpdate(object entity)
        {
            //try
            //{
            //    OpenConnection();
        ...
        public void NewHero(String name, String role)
        {
        //    try
        //    {
        //        OpenConnection();
       ...
       // public static Hero GetUser(string name)
        //{
                //try
                //{
                //    OpenConnection();
                ...
                //            Hero hero = new Hero
                //            {
                //                Id = Convert.ToInt32(data["HeroID"]),
                //                Name = data["Name"].ToString(),
                //                Level = Convert.ToInt32(data["Level"]),
                //                Xp = Convert.ToInt32(data["XP"]),
                //                InventoryId = Convert.ToInt32(data["InventoryID"]),
                //                StatsId = Convert.ToInt32(data["StatsID"]),
                ...
                //}
        //}
        //public List<Dictionary<string, object>> GetObject(string tableName, int objectId)
        //{
                ...
                //                    else
                //                    {
                //                        Debug.LogWarning("Error, couldn't found item");
                //                    }
                //                }
                //            }
                //        }
